...
namespace Microsoft.VisualStudio.Project.Samples.CustomProject
{
	...
	public class GeneralPropertyPage : SettingsPage
	{
	    ...
	    private string clojureFrameworkPath;
		#endregion Fields
	    ...
	    public string ClojureFrameworkPath
	    {
            get
            {
                return clojureFrameworkPath;
            }

            set
            {
                clojureFrameworkPath = value;
                IsDirty = true;
            }
	    }
		...
		protected override void BindProperties()
		{
		    ...
		    this.clojureFrameworkPath = this.ProjectMgr.GetProjectProperty("ClojureFrameworkPath", false);
		...
		protected override int ApplyChanges()
		{
            ...
            this.ProjectMgr.SetProjectProperty("ClojureFrameworkPath", this.clojureFrameworkPath);
			if (reloadRequired)
			{
